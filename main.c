...
/*   Updated: 2023/01/20 16:55:44 by hanmpark         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "includes/scholarship_logtime.h"

static void	print_result(int month, int lmonth, char **date, char **bonus_date)
{
	int		i;
	...
	ccl_logtime(month, lmonth, date, bonus_date);
}
