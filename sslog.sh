...
function show_help() {
  ...
  printf "Options:\n"
  printf "  -l, --login   : Le login de l'utilisateur\n"
  printf "  -m, --month   : Le mois\n"
  printf "  -s            : L'option s\n"
}
...
# RUNNING PROGRAM
make > /dev/null 2>&1
mv scholarship_logtime.a "$SRC_FOLDER"/scholarship_logtime.a > /dev/null 2>&1

gcc "$SRC_FOLDER"/scholarship_logtime.a -o calculator > /dev/null 2>&1
